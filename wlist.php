...
<?php 
    ...
    if (isset($_GET['delwlistid'])) {
        ...
        $id = $_GET['delwlistid'];
        $delwlist  = $cat->wlistDel($cmrId,$id);
    }
			    	...
			    	<h2>WishList</h2>
						...
						<table class="tblone">
							...
							<?php 
									...
									$getAllwlist = $cart->getAllWlist($cmrId);
									if ($getAllwlist) {
										$i   = 0;
										while ($result = $getAllwlist->fetch_assoc()) {
											$i++;
											?>
							...
							<tr>
								...
								<td><a href="details.php?proid=<?php echo $result['productId'];  ?>">Buy Now</a> || <a href="?delwlistid=<?php echo $result['productId'];  ?>">Remove</a></td>
